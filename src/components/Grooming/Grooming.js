...
import mavGoose from '../../../public/assets/mavgoose.webp';
    ...
    <div className='grooming'>
      ...
      <div className='grooming__container'>
        <div className='grooming__wrapper'>
          ...
          <ul className='grooming__items'>
            <GroomCards src={catBath} text='Cat Services' label='Cat Care' path='/prices' />
            <GroomCards src={mavGoose} text='Price List' label='Prices' path='/prices' />
            <GroomCards src={splashDash} text='Splash & Dash' label='Shake it Off' path='/prices' />
          </ul>
        </div>
      </div>
    </div>
